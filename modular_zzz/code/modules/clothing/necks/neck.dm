/obj/item/clothing/neck/cloak/tendercloak
	...
	icon = 'modular_zzz/icons/obj/clothing/necks.dmi'
	worn_icon = 'modular_zzz/icons/mob/clothing/necks.dmi'
	worn_icon_digi = 'modular_zzz/icons/mob/clothing/necks.dmi'
	icon_state = "ten_neck"
